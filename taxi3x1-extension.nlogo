...
extensions [ array table qlearningextension ]
...
to setup
  ...
  ; configurando a extension
  ask taxis [
    qlearningextension:state-def [ "passengerOriginX" "passengerOriginY" "passengerDestX" "passengerDestY" "xcor" "ycor" "passengerBoarded"]
    (qlearningextension:actions [goUp] [goRight] [goDown] [goLeft] [pickUp] [dropOff])
    qlearningextension:reward [ reward ]
    qlearningextension:end-episode [ episodeEnded ] newEpisode
